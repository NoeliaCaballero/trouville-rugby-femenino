...
import { categories, clubInfo } from '../services/clubService';
            ...
            <Card className="card-modern">
              <Card.Body className="p-8">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold mb-4">Horarios y Ubicación</h3>
                  <p className="text-gray-600 mb-6">
                    Consulta nuestros horarios de entrenamiento y la ubicación de la cancha.
                  </p>
                  <Button
                    variant="secondary"
                    size="large"
